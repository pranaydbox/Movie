window.onload=()=>{
    ...
    $.post(host+"/movies/getownermovies",{curremail:localStorage.getItem("currentLoginUser")},(xhr,status,responseText)=>{
    ...
    $.post(host+"/movies/getexistingmovies",{curremail:localStorage.getItem("currentLoginUser")},(xhr,status,responseText)=>{
...
function addexistingmovie(movieId){
    $.post(host+"/movies/addexisting/"+movieId,{curremail:localStorage.getItem("currentLoginUser")},(xhr,status,responseText)=>{
        alert(responseText.responseText);
    })
}
...
function deletemoviefromtheatre(movieId){
    alert(movieId);
    $.post(host+"/movies/removeownermovie",{curremail:localStorage.getItem("currentLoginUser"),movieId:movieId},(xhr,status,responseText)=>{
        alert(responseText.responseText);
    })
}
